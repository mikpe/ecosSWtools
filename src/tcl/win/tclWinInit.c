...
"proc init {} {\n\
    ...
    # CYGNUS LOCAL: change lib to share.\n\
    lappend dirs [file join [file dirname [file dirname [info nameofexecutable]]] share/tcl$tcl_version]\n\
    # CYGNUS LOCAL: allow for one level of exec_prefix.\n\
    lappend dirs [file join [file dirname [file dirname [file dirname [info nameofexecutable]]]] share/tcl$tcl_version]\n\
    ...
    Tcl_Interp *interp;
{
    ...
    /* CYGNUS LOCAL: don't set tcl_library from the registry; instead
