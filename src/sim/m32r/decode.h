...
#define SEM(fn) CONCAT3 (m32r,_sem_,fn)
#define SEMF(fn) CONCAT3 (m32r,_semf_,fn)

extern EXTRACT_FN EX (illegal);
extern SEMANTIC_FN SEM (illegal);
extern SEMANTIC_FN SEMF (illegal);
extern EXTRACT_FN EX (fmt_add);
extern EXTRACT_FN EX (fmt_add3);
extern EXTRACT_FN EX (fmt_and3);
extern EXTRACT_FN EX (fmt_or3);
extern EXTRACT_FN EX (fmt_addi);
extern EXTRACT_FN EX (fmt_addv);
extern EXTRACT_FN EX (fmt_addv3);
extern EXTRACT_FN EX (fmt_addx);
extern EXTRACT_FN EX (fmt_bc8);
extern EXTRACT_FN EX (fmt_bc24);
extern EXTRACT_FN EX (fmt_beq);
extern EXTRACT_FN EX (fmt_beqz);
extern EXTRACT_FN EX (fmt_bl8);
extern EXTRACT_FN EX (fmt_bl24);
extern EXTRACT_FN EX (fmt_bra8);
extern EXTRACT_FN EX (fmt_bra24);
extern EXTRACT_FN EX (fmt_cmp);
extern EXTRACT_FN EX (fmt_cmpi);
extern EXTRACT_FN EX (fmt_div);
extern EXTRACT_FN EX (fmt_jl);
extern EXTRACT_FN EX (fmt_jmp);
extern EXTRACT_FN EX (fmt_ld);
extern EXTRACT_FN EX (fmt_ld_d);
extern EXTRACT_FN EX (fmt_ldb);
extern EXTRACT_FN EX (fmt_ldb_d);
extern EXTRACT_FN EX (fmt_ldh);
extern EXTRACT_FN EX (fmt_ldh_d);
extern EXTRACT_FN EX (fmt_ld_plus);
extern EXTRACT_FN EX (fmt_ld24);
extern EXTRACT_FN EX (fmt_ldi8);
extern EXTRACT_FN EX (fmt_ldi16);
extern EXTRACT_FN EX (fmt_lock);
extern EXTRACT_FN EX (fmt_machi);
extern EXTRACT_FN EX (fmt_mulhi);
extern EXTRACT_FN EX (fmt_mv);
extern EXTRACT_FN EX (fmt_mvfachi);
extern EXTRACT_FN EX (fmt_mvfc);
extern EXTRACT_FN EX (fmt_mvtachi);
extern EXTRACT_FN EX (fmt_mvtc);
extern EXTRACT_FN EX (fmt_nop);
extern EXTRACT_FN EX (fmt_rac);
extern EXTRACT_FN EX (fmt_rte);
extern EXTRACT_FN EX (fmt_seth);
extern EXTRACT_FN EX (fmt_sll3);
extern EXTRACT_FN EX (fmt_slli);
extern EXTRACT_FN EX (fmt_st);
extern EXTRACT_FN EX (fmt_st_d);
extern EXTRACT_FN EX (fmt_stb);
extern EXTRACT_FN EX (fmt_stb_d);
extern EXTRACT_FN EX (fmt_sth);
extern EXTRACT_FN EX (fmt_sth_d);
extern EXTRACT_FN EX (fmt_st_plus);
extern EXTRACT_FN EX (fmt_trap);
extern EXTRACT_FN EX (fmt_unlock);
