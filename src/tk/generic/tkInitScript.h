...
"proc tkInit {} {\n\
    ...
    lappend dirs [file join $parentDir share tk$tk_version]\n\
    lappend dirs [file join $parentDir library]\n\
    # CYGNUS LOCAL: strip symlink component from path\n\
    if {![interp issafe]} then {\n\
	set here [pwd]\n\
	cd [file dirname [info nameofexecutable]]\n\
	lappend dirs [file join [file dirname [file dirname [pwd]]] share tk$tk_version]\n\
	cd $here\n\
    }\n\
    # END CYGNUS LOCAL\n\
